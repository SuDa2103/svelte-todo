...
<div class="container">
    <img src={'/img/CTSWLogo.png'} alt="CodingTheSmartWay Logo">
    ...
    <div class="inner-container">
        <div><label> <input class="inner-container-input" type="checkox" on:change={checkAllTodos} Check All></label></div>
